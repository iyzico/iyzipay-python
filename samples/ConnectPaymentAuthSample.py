...
from src.Iyzipay.Model.ConnectPaymentAuth import ConnectPaymentAuth


class ConnectPaymentAuthSample(BaseSample, unittest.TestCase):
    def runTest(self):
    ...
    def should_pay_with_card(self):
        ...
        connect_payment_auth = ConnectPaymentAuth.create(request, BaseSample.options)

        pprint.pprint(connect_payment_auth)
