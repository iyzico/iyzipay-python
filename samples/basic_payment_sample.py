...
class BasicPaymentSample(unittest.TestCase):
    def runTest(self):
    ...
    def should_pay_with_card(self):
        ...
        # make request
        basic_payment = iyzipay.BasicPayment()
        basic_payment_response = basic_payment.create(request, options)

        # get and print response
        print(basic_payment_response.read().decode('utf-8'))
